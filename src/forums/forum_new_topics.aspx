<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forum_new_topics.aspx.cs" Inherits="forums_forum_new_topics" %>
...
<body topmargin="0" leftmargin="0">
    ...
    <div align="center">
      <table border="0" width="993" cellspacing="0" cellpadding="0" height="536" bgcolor="#FFFFFF" id="table2">
        <tr>
        ...
        <tr>
          <td valign="top" align="left" height="510">
            <div align="left">
              <table border="0" width="100%" cellpadding="2" id="table4">
                ...
                <tr>
                  <td width="100%" colspan="2"><br>
					<a href="../default.aspx">eForum</a><b> &gt;&gt; <% Response.Write(StrForumName) ;%> - New Topic / Question<br/>
					</b> <br>
					&nbsp;</td>
                </tr>
                <tr>
						...
						<tr>
							...
							<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" id="table8">
								<tr>
											...
											<p align="center">
					<b><font size="2"><% Response.Write(StrForumName);%></font></b></td>
										</tr>
								<tr>
