<%@ Page Language="C#" AutoEventWireup="true" CodeFile="member_signin.aspx.cs" Inherits="members_member_signin" %>
                  	...
                  	<table border="0" width="88%" cellspacing="1" bgcolor="#000000" id="table5">
						<tr>
							...
							<table border="0" width="100%" cellpadding="3" bgcolor="#FFFFFF" id="table6">
								<tr>
									<td width="4">&nbsp;</td>
									<td width="110"><b>Please Sign IN</b></td>
									<td width="10">&nbsp;</td>
								...
								<tr>
									...
									<td width="110" style="height: 42px">Password</td>
									<td width="10" style="height: 42px">:</td>
									<td style="width: 353px; height: 42px">&nbsp;<asp:TextBox ID="TxtPassword" runat="server" CssClass="TextBoxStyle" TextMode="Password"></asp:TextBox>
						...
						<p>If you forget your password click here to
						<a href="forgetpassword.aspx">Get Password</a></p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
						<p>&nbsp;</p>
